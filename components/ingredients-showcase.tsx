...
const ingredientDatabase: Record<string, Ingredient> = {
  Apple: {
    ...
    description:
      "Crisp and refreshing, apples add natural sweetness and essential fiber.",
    category: "Fruits",
  },
  Carrot: {
    name: "Carrot",
    ...
    description:
      "Rich in beta carotene and vitamin A for eye health and immunity.",
    category: "Vegetables",
  },
  Ginger: {
    name: "Ginger",
    ...
    description:
      "Powerful anti-inflammatory properties and aids in digestion and immunity.",
    category: "Spices",
  },
  Kale: {
    name: "Kale",
    ...
    description:
      "A nutritional powerhouse loaded with vitamins, minerals, and powerful antioxidants.",
  ...
  Lemon: {
    ...
    description:
      "Rich in vitamin C and natural detoxifying properties, adds zesty freshness.",
    category: "Citrus",
  },
  Spinach: {
    name: "Spinach",
    ...
    description:
      "Packed with iron and vitamins, spinach provides essential nutrients for energy and bone health.",
    category: "Leafy Greens",
  },
  Avocado: {
    name: "Avocado",
    ...
    description:
      "Creamy avocado rich in healthy monounsaturated fats and potassium.",
    category: "Fruits",
  },
  Berries: {
    name: "Berries",
    ...
    description:
      "Mixed berries packed with antioxidants and natural compounds.",
    category: "Berries",
  },
  Cucumber: {
    name: "Cucumber",
    ...
    description:
      "Extremely hydrating and low in calories, perfect for refreshing drinks.",
    category: "Vegetables",
  },
  Mint: {
    name: "Mint",
    ...
    description:
      "Refreshing and aromatic, mint aids digestion and adds cooling properties.",
    category: "Herbs",
  },
  Orange: {
    name: "Orange",
    ...
    description:
      "Fresh citrus fruit packed with vitamin C and natural sweetness.",
    category: "Citrus",
  },
  Mango: {
    name: "Mango",
    ...
    description:
      "Rich in beta carotene and vitamin A, provides natural tropical sweetness.",
  ...
  Pineapple: {
    ...
    description:
      "Contains bromelain enzyme for digestion and brings tropical sweetness.",
    category: "Tropical Fruits",
  },
  Beetroot: {
    name: "Beetroot",
    ...
    description:
      "Rich in nitrates that support blood flow and athletic performance.",
    category: "Vegetables",
  },
  Celery: {
    name: "Celery",
    ...
    description:
      "Hydrating vegetable with natural minerals and very low calories.",
    category: "Vegetables",
  },
  Blueberry: {
    name: "Blueberry",
    ...
    description:
      "Known for brain health benefits and high antioxidant content.",
    category: "Berries",
  },
  Parsley: {
    name: "Parsley",
    image: "/images/ingredients/parsley.webp",
    benefits: ["Vitamin K", "Fresh Flavor", "Detox"],
    description:
      "Fresh herb rich in vitamin K and natural detoxifying compounds.",
    category: "Herbs",
  },
  Watermelon: {
    name: "Watermelon",
    ...
    description:
      "Extremely hydrating fruit with lycopene and natural sweetness.",
    category: "Fruits",
  },
  Banana: {
    name: "Banana",
    ...
    description:
      "Rich in potassium and natural sugars, provides sustained energy and creamy texture.",
    category: "Fruits",
  },
  "Coconut Water": {
    name: "Coconut Water",
    ...
    description:
      "Natural electrolyte source, perfect for hydration and mineral replenishment.",
  ...
  Turmeric: {
    ...
    description:
      "Powerful anti-inflammatory spice with curcumin for health benefits.",
    category: "Spices",
  },
  "Mixed Greens": {
    name: "Mixed Greens",
    ...
    description:
      "A variety of fresh leafy greens providing essential vitamins and minerals.",
    category: "Leafy Greens",
  },
  Chia: {
    name: "Chia",
    ...
    description:
      "Tiny seeds packed with omega-3 fatty acids, fiber, and protein.",
    category: "Seeds",
  },
  Almonds: {
    name: "Almonds",
    ...
    description:
      "Nutrient-dense nuts rich in healthy fats, protein, and vitamin E.",
    category: "Nuts",
  },
  "Raw Honey": {
    name: "Raw Honey",
    ...
    description:
      "Unprocessed honey with natural antibacterial properties and sustained energy.",
...
export default function IngredientsShowcase({
  ...
  const getIngredientData = (ingredientName: string): Ingredient => {
    ...
    const matchedKey = Object.keys(ingredientDatabase).find(
      (key) => key.toLowerCase() === lowerIngredient
    );
    ...
    return {
      ...
      benefits: ["Natural", "Fresh"],
      description:
        "A fresh, natural ingredient that adds flavor and nutrition.",
      category: "Other",
    };
  };
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="text-center animate-fade-in-up">
        ...
        <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          Every ingredient is carefully selected for maximum nutrition and
          flavor
        </p>
      </div>
      ...
      >
        ...
        <p className="text-purple-100 max-w-2xl mx-auto text-sm sm:text-base">
          Our ingredients are sourced from local organic farms and delivered
          fresh daily to ensure maximum nutritional value and taste!
        </p>
      </div>
    </div>
  );
