...
const ingredientDatabase: Record<string, Ingredient> = {
  ...
  Carrot: {
    name: "Carrot",
    image: "/images/ingredients/carrots.jpg",
  ...
  Avocado: {
    name: "Avocado",
    image: "/images/ingredients/avocado.jpg",
  ...
  Orange: {
    ...
    description: "Fresh citrus fruit packed with vitamin C and natural sweetness.",
    category: "Citrus",
  },
  Mango: {
    name: "Mango",
  ...
  Blueberry: {
    name: "Blueberry",
    image: "/images/ingredients/blueberries.jpg",
  ...
  Parsley: {
    name: "Parsley",
    image: "/images/ingredients/parsley.jpg",
    benefits: ["Vitamin K", "Fresh Flavor", "Detox"],
    description: "Fresh herb rich in vitamin K and natural detoxifying compounds.",
    category: "Herbs",
  },
  Watermelon: {
    name: "Watermelon",
  ...
  Banana: {
    name: "Banana",
    image: "/images/ingredients/banana.jpg",
  ...
  "Coconut Water": {
    name: "Coconut Water",
    image: "/images/ingredients/coconut-water.jpg",
  ...
  "Mixed Greens": {
    name: "Mixed Greens",
    image: "/images/ingredients/mixed-greens.jpg",
  ...
  Chia: {
    name: "Chia",
    image: "/images/ingredients/chia-seeds.jpg",
...
export default function IngredientsShowcase({ ingredients = [] }: IngredientsShowcaseProps) {
  ...
  const getIngredientData = (ingredientName: string): Ingredient => {
    ...
    return {
      name: ingredientName,
      image: "/images/ingredients/mixed-greens.jpg", // Default to mixed greens image
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-3 sm:p-4 text-center border border-blue-200 dark:border-blue-700">
          ...
          <div className="text-xs sm:text-sm text-blue-700 dark:text-blue-300">Organic</div>
        </div>
        <div className="bg-green-50 dark:bg-green-900/20 rounded-2xl p-3 sm:p-4 text-center border border-green-200 dark:border-green-700">
          <div className="text-xl sm:text-2xl font-bold text-green-600 dark:text-green-400">Fresh</div>
      ...
      >
        ...
        <p className="text-purple-100 max-w-2xl mx-auto text-sm sm:text-base">
          Our ingredients are sourced from local organic farms and delivered fresh daily to ensure maximum nutritional
          value and taste!
        </p>
      </div>
    </div>
